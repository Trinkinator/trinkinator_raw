...
class _GameState extends State<Game> {
  ...
  void _gameAlertDialog(BuildContext context) {
    showDialog(
      context: context,
  ...
  Widget _startGame(BuildContext context, int j, int i) {
            ...
            Text.rich(
              TextSpan(
                children: <TextSpan>[
                  ...
                  TextSpan(
                      text: aufgaben[random.nextInt(34)] +
                          '\n', //Anzahl der Aufgaben.
  ...
  Widget _blankScreen(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute<void>(builder: (BuildContext context) {
      return Scaffold();
    }));
  ...
  Widget _spielerzahl(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute<void>(builder: (BuildContext context) {
      return Scaffold(
        body: ListView(
            ...
            children: [
              ...
              RaisedButton(
                  ...
                  shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(color: Colors.blueGrey)),
                  color: Colors.lightGreen[500],
                  child: Text('Prost!', style: TextStyle(fontSize: 30.0))),
            ],
          )));
    }));
  }
            ...
            children: [
              ...
              RaisedButton(
                  ...
                  shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(color: Colors.blueGrey)),
                  color: Colors.lightGreen[500],
                  child: Text('Verstanden!', style: TextStyle(fontSize: 30.0))),
            ],
          ));
    }));
  }
